...
import "../components/styles/header.min.css";
      ...
      <div className="container">
        ...
        >
          <div className="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            ...
            <div className="header-navbar" style={{ fontSize: "1.4rem" }}>
              <ul className="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                ...
                <li>
                  <a
                    ...
                    target="_blank"
                  >
                    <VscGithubInverted className="nav-social-logo" />
                  </a>
                </li>
                <li>
                  <a
                    ...
                    target="_blank"
                  >
                    <FaLinkedin className="nav-social-logo" />
                  </a>
                </li>
                <li>
                  <a
                    ...
                    target="_blank"
                  >
                    <SiLeetcode className="nav-social-logo" />
                  </a>
                </li>
                <li>
                  <a
